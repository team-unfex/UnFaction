...
public class Faction {
	...
	public Faction(String name, String description, List<FactionPlayer> members, List<String> challengesCompleted, World homeWorld, int homeX, int homeY, int homeZ) {
		this.name = name;
